...
const Navbar = () => {
  ...
  return (
    <Container className="sticky top-0 z-100">
      <div className="bg-base-100">
        <div className="navbar shadow-md  md:px-8 mx-auto ">
          {/* Left: Logo */}
          ...
          <div className="navbar-end gap-2">
            {!user ? (
              <>
                <Link
                  to="/login"
                  className="btn btn-outline btn-info hover:outline-red-400 hover:bg-cyan-700 btn-md rounded-lg"
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  className="btn  bg-cyan-600 btn-md rounded-lg hover:bg-cyan-800 text-amber-50"
                >
                  Register
                </Link>
              </>
